...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white dark:bg-charcoal-900 border-r border-charcoal-100 dark:border-charcoal-800 flex flex-col min-h-screen sticky top-0">
      {/* Logo */}
      <div className="px-6 py-6 border-b border-charcoal-100 dark:border-charcoal-800">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-charcoal rounded-lg flex items-center justify-center">
            <span className="text-white text-sm font-black">R</span>
          </div>
